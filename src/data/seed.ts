...
// Helper: distribute milestone dates evenly between action start and due
...
const REVENUE = node('s1', null, 0, '연 매출 500억 달성', '💰', 500, 280, '억원', 0.50, 0, { start_date: '2026-01-01', due_date: '2026-12-31' })
const RETENTION = node('s2', null, 0, '고객 유지율 95%', '🤝', 95, 88, '%', 0.30, 1, { start_date: '2026-01-01', due_date: '2026-12-31' })
const INNOVATION = node('s3', null, 0, '신제품 3건 출시', '🚀', 3, 1, '건', 0.20, 2, { start_date: '2026-01-01', due_date: '2026-12-31' })

// Depth 1: Team KPIs under Revenue
const SALES_GROWTH = node('t1', 's1', 1, '영업팀 매출 성장', '📈', 100, 65, '%', 0.5, 0, { start_date: '2026-01-01', due_date: '2026-09-30' })
const MARKETING_LEADS = node('t2', 's1', 1, '마케팅 리드 생성', '🎯', 100, 72, '%', 0.3, 1, { start_date: '2026-01-01', due_date: '2026-09-30' })
const PARTNERSHIPS = node('t3', 's1', 1, '파트너십 확대', '🤝', 100, 45, '%', 0.2, 2, { start_date: '2026-01-01', due_date: '2026-09-15' })

// Depth 1: Team KPIs under Retention
const SUPPORT_QUALITY = node('t4', 's2', 1, 'CS 만족도 향상', '⭐', 100, 82, '%', 0.4, 0, { start_date: '2026-01-01', due_date: '2026-09-30' })
const PRODUCT_NPS = node('t5', 's2', 1, '제품 NPS 개선', '📊', 100, 70, '%', 0.6, 1, { start_date: '2026-01-01', due_date: '2026-09-30' })

// Depth 1: Team KPIs under Innovation
const RND_DELIVERY = node('t6', 's3', 1, 'R&D 프로젝트 납기', '🔬', 100, 50, '%', 0.5, 0, { start_date: '2026-01-01', due_date: '2026-09-15' })
const DESIGN_SPRINT = node('t7', 's3', 1, '디자인 스프린트 완료', '🎨', 100, 60, '%', 0.5, 1, { start_date: '2026-01-01', due_date: '2026-09-15' })

// Depth 2: Actions under Sales Growth
const A1 = node('a1', 't1', 2, 'Q2 대형 고객 5건 미팅', '📞', 5, 3, '건', 0.40, 0, {
  owner_id: 'demo-kim', start_date: '2026-01-15', due_date: '2026-06-30',
  milestones: distributeDates('2026-01-15', '2026-06-30', [
...
const A2 = node('a2', 't1', 2, '기존 고객 업셀링 캠페인', '💎', 4, 3, '건', 0.35, 1, {
  owner_id: 'demo-kim', start_date: '2026-02-01', due_date: '2026-07-31',
  milestones: distributeDates('2026-02-01', '2026-07-31', [
...
const A3 = node('a3', 't1', 2, '영업 프로세스 자동화', '⚙️', 5, 3, '건', 0.25, 2, {
  owner_id: 'demo-park', start_date: '2026-01-15', due_date: '2026-08-31',
  milestones: distributeDates('2026-01-15', '2026-08-31', [
...
const A4 = node('a4', 't2', 2, '콘텐츠 마케팅 30건', '📝', 6, 4, '건', 0.50, 0, {
  owner_id: 'demo-lee', start_date: '2026-01-15', due_date: '2026-07-31',
  milestones: distributeDates('2026-01-15', '2026-07-31', [
...
const A5 = node('a5', 't2', 2, 'SEO 키워드 순위 개선', '🔍', 4, 3, '건', 0.50, 1, {
  owner_id: 'demo-lee', start_date: '2026-02-01', due_date: '2026-08-31',
  milestones: distributeDates('2026-02-01', '2026-08-31', [
...
const A6 = node('a6', 't4', 2, '응답 시간 1시간 이내', '⏱️', 4, 3, '건', 0.50, 0, {
  owner_id: 'demo-choi', start_date: '2026-01-15', due_date: '2026-06-30',
  milestones: distributeDates('2026-01-15', '2026-06-30', [
...
const A7 = node('a7', 't4', 2, 'FAQ 자동화 구축', '🤖', 5, 2, '건', 0.50, 1, {
  owner_id: 'demo-choi', start_date: '2026-02-01', due_date: '2026-08-31',
  milestones: distributeDates('2026-02-01', '2026-08-31', [
...
const A8 = node('a8', 't5', 2, 'UX 리디자인 Phase 1', '🎨', 4, 3, '건', 0.60, 0, {
  owner_id: 'demo-park', start_date: '2026-01-15', due_date: '2026-07-31',
  milestones: distributeDates('2026-01-15', '2026-07-31', [
...
const A9 = node('a9', 't5', 2, '피드백 수집 시스템', '📋', 3, 1, '건', 0.40, 1, {
  owner_id: 'demo-user', start_date: '2026-03-01', due_date: '2026-09-15',
  milestones: distributeDates('2026-03-01', '2026-09-15', [
...
const A10 = node('a10', 't6', 2, 'MVP 프로토타입 완료', '🔧', 5, 2, '건', 0.60, 0, {
  owner_id: 'demo-user', status: 'at_risk', start_date: '2026-01-15', due_date: '2026-07-31',
  milestones: distributeDates('2026-01-15', '2026-07-31', [
...
const A11 = node('a11', 't6', 2, '기술 검증 테스트', '🧪', 4, 2, '건', 0.40, 1, {
  owner_id: 'demo-park', start_date: '2026-02-01', due_date: '2026-08-31',
  milestones: distributeDates('2026-02-01', '2026-08-31', [
...
const A12 = node('a12', 't7', 2, '사용자 인터뷰 20건', '🗣️', 4, 3, '건', 0.50, 0, {
  owner_id: 'demo-lee', start_date: '2026-01-15', due_date: '2026-06-30',
  milestones: distributeDates('2026-01-15', '2026-06-30', [
...
const A13 = node('a13', 't7', 2, '프로토타입 사용성 테스트', '🧩', 3, 1, '건', 0.50, 1, {
  owner_id: 'demo-kim', start_date: '2026-02-01', due_date: '2026-08-31',
  milestones: distributeDates('2026-02-01', '2026-08-31', [
